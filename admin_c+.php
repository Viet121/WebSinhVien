        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li id="like"><a href="admin_c+.php">
                    <i class="uil uil-book-reader" style="color:#0E4BF1;"></i>
                    <span class="link-name" style="color:#0E4BF1;">Giáo viên</span>
                </a></li>
        ...
        <div class="top">
            ...
            <div class="search-box">
                <form method="get">
                    ...
                    <input type="text" name="search" placeholder="Tìm kiếm theo msgv...">
                </form>   
            </div>
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">Danh sách thông tin giáo viên</span>
                </div>
                    ...
                    <tbody>
                        <?php
                            ...
                            if(isset($_GET['search']) && $_GET['search'] != ''){
                                ...
                                $lietke_sql = "SELECT * FROM giaovien WHERE maGV LIKE '%" . $search . "%' ORDER BY maGV";
                            }
                            else{
                        ...
                        ?>
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <a href = "editGV.php?smaGV=<?php echo $r['maGV'];?>" class="btn btn-outline-primary">Sửa</a>
                                    <a onclick="return confirm('Bạn có muốn xoá giáo viên này không !');" href = "xoaGV.php?smaGV=<?php echo $r['maGV'];?>" class="btn btn-outline-danger">Xóa</a>
                                </td>
                            </tr>
                        <?php
                        }
                ...
                <br>
                <div style="float:right; margin-right: 25px;"><a href = "form+GV.php" class="btn btn-outline-success">Thêm giáo viên</a></div>        
